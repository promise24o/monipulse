! function(t, e) {
    ...
    var A = function() {
            ...
            return t.prototype.render = function() {
                var t, e = this._series.scale.getTicks(),
    ...
    var T = {
            ...
            _setScale: function(t, e, i, s, a) {
                ...
                }), 10)) : (this.transX = d, this.transY = f, this.scale = t, this._applyTransform(), this._emit(k.onViewportChange, [this.scale, this.transX, this.transY]))
            },
            setFocus: function(t) {
                var e = this;
                void 0 === t && (t = {});
            ...
            _repositionLabels: function() {
                ...
                if (t) {
                    ...
                    if (t.markers)
                        for (var i in this._markers) this._markers[i].element.updateLabelPosition()
                }
            }
        },
        z = function() {
