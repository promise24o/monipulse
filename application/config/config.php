...
| path to your installation, but   to security concerns the hostname will
...
|
*/
$config['base_url'] = 'https://mimisvapp.com/';
...
$config['smtp_user']   = 'support@mimisvapp.com';
$config['smtp_pass']   = 'Support@Password2025';
