				...
				<div class="row row-sm">
					<div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
						<div class="mt-5 pt-4 p-2 pos-absolute">
							...
							<span class="tx-white-6 tx-13 mb-5 mt-xl-0">Join now to create your account and become part of a global community. Experience seamless connectivity like never before.</span>
						</div>
					</div>
						...
						<div class="main-container container-fluid">
							<div class="row row-sm">
								<div class="card-body mt-2 mb-2">
									...
									<form method="post" action="<?= base_url('auth/confirm_register') ?>">
										<h5 class="text-start mb-2">Create Account</h5>
										<div class="form-group text-start">
											<label>Fullname</label>
											<input class="form-control" name="fullname" placeholder="John Smith" type="text" required>
										</div>
										<div class="form-group text-start">
											<label>Email</label>
											<input class="form-control" name="email" placeholder="example.mail.com" type="text" required>
										</div>
										<div class="form-group text-start">
											<label>Phone</label>
											<input class="form-control" name="phone" placeholder="+123456789" type="tel" required>
										</div>
										<div class="form-group text-start">
									...
									<div class="text-start mt-5 ms-0">
										...
										<div>Already have an? <a href="<?= base_url('get-started') ?>">Sign In Here</a></div>
									</div>
								</div>
							</div>
						</div>
