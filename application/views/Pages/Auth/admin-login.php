				...
				<div class="row row-sm">
					<div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
						<div class="mt-5 pt-4 p-2 pos-absolute">
							...
							<h5 class="mt-4 text-white">Admin Dashboard Login</h5>
							<span class="tx-white-6 tx-13 mb-5 mt-xl-0">Login now to access the admin dashboard. Explore, manage, and connect with administrative privileges. Unlock the power of seamless connectivity at your fingertips.</span>
						</div>
					</div>
							...
							<div class="row row-sm">
								<div class="card-body mt-2 mb-2">
									...
									<div class="text-start mt-5 ms-0">
										<div class="mb-1">Forgot password?<a href="<?= base_url('forgot-password') ?>"> Reset Here</a> </div>
									</div>
								</div>
							</div>
						</div>
