									...
									<div class="row align-items-center">
										<div class="offset-xl-3 offset-sm-6 col-xl-8 col-sm-6 col-12 img-bg ">
											<h4 class="d-flex  mb-3">
												<span class="font-weight-bold text-white ">Admin Dashboard</span>
											</h4>
											<p class="tx-white-7 mb-1">Get Insights on the number of users, transactions, and transaction types on the dashbaord.  
											</p>
										</div>
										<img src="https://php.spruko.com/spruha/spruha/assets/img/pngs/work3.png" alt="user-img">
									</div>
								</div>
							</div>
						</div>
											...
											<div class="card-item-stat">
												<h4 class="font-weight-bold">
													...
													foreach ($transactions as $trans) {
														$total_service_revenue = $total_service_revenue + $trans['amount'];
													}

													echo "₦" . number_format($total_service_revenue, 2);
													?>
												</h4>
							...
							<div class="card custom-card">
								<div class="card-body">
									<div class="card-item">
										...
										<div class="card-item-title mb-2">
											<label class="main-content-label tx-13 font-weight-bold mb-1">Total User Fundings</label>
							...
							<div class="card custom-card">
								<div class="card-body">
									<div class="card-item">
										...
										<div class="card-item-body">
											<div class="card-item-stat">
												<h4 class="font-weight-bold"><?= $this->db->get('users')->num_rows() ?></h4>
							...
							<div class="card custom-card">
								<div class="card-body">
									<div class="card-item">
										...
										<div class="card-item-title  mb-2">
											<label class="main-content-label tx-13 font-weight-bold mb-1">Today's
												Revenue</label>
										</div>
										<div class="card-item-body">
											<div class="card-item-stat">
												<h4 class="font-weight-bold">
													<?php echo "₦". number_format($this->crud_model->get_today_revenue(), 2); ?>
												 </h4>
												<small><b class="text-success">12%</b> incrase</small>
											</div>
										</div>
									</div>
								</div>
